...
public class TodoControllerImplApi {
     ...
     */
    public okhttp3.Call createItemCall(TodoEntryDto todoEntryDto, String name, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createItemValidateBeforeCall(TodoEntryDto todoEntryDto, String name, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createItemCall(todoEntryDto, name, _callback);
        return localVarCall;
     ...
     */
    public void createItem(TodoEntryDto todoEntryDto, String name) throws ApiException {
        createItemWithHttpInfo(todoEntryDto, name);
    }
     ...
     */
    public ApiResponse<Void> createItemWithHttpInfo(TodoEntryDto todoEntryDto, String name) throws ApiException {
        okhttp3.Call localVarCall = createItemValidateBeforeCall(todoEntryDto, name, null);
     ...
     */
    public okhttp3.Call createItemAsync(TodoEntryDto todoEntryDto, String name, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = createItemValidateBeforeCall(todoEntryDto, name, _callback);
     ...
     */
    public okhttp3.Call updateItemCall(TodoEntryDto todoEntryDto, String name, String itemName, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = todoEntryDto;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateItemValidateBeforeCall(TodoEntryDto todoEntryDto, String name, String itemName, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateItemCall(todoEntryDto, name, itemName, _callback);
        return localVarCall;
     ...
     */
    public void updateItem(TodoEntryDto todoEntryDto, String name, String itemName) throws ApiException {
        updateItemWithHttpInfo(todoEntryDto, name, itemName);
    }
     ...
     */
    public ApiResponse<Void> updateItemWithHttpInfo(TodoEntryDto todoEntryDto, String name, String itemName) throws ApiException {
        okhttp3.Call localVarCall = updateItemValidateBeforeCall(todoEntryDto, name, itemName, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateItemAsync(TodoEntryDto todoEntryDto, String name, String itemName, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateItemValidateBeforeCall(todoEntryDto, name, itemName, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     */
    public okhttp3.Call updateListCall(TodoListDto todoListDto, String name, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = todoListDto;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateListValidateBeforeCall(TodoListDto todoListDto, String name, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateListCall(todoListDto, name, _callback);
        return localVarCall;
     ...
     */
    public void updateList(TodoListDto todoListDto, String name) throws ApiException {
        updateListWithHttpInfo(todoListDto, name);
    }
     ...
     */
    public ApiResponse<Void> updateListWithHttpInfo(TodoListDto todoListDto, String name) throws ApiException {
        okhttp3.Call localVarCall = updateListValidateBeforeCall(todoListDto, name, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateListAsync(TodoListDto todoListDto, String name, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateListValidateBeforeCall(todoListDto, name, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
