...
from ProjectName.Client import rest
from ProjectName.Client.configuration import Configuration
from ProjectName.Client.exceptions import ApiTypeError, ApiValueError, ApiException
from ProjectName.Client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ApiControllerApi()
        api_instance.version  # this is an instance of the class Endpoint
        api_instance.version()  # this invokes api_instance.version.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.version.callable or self.callable in this class
