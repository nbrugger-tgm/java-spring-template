...
import com.domain.projectname.client.auth.Authentication;
import com.domain.projectname.client.auth.ApiKeyAuth;
import com.domain.projectname.client.auth.HttpBasicAuth;
import com.domain.projectname.client.request.GetRequest;
import com.domain.projectname.client.request.PostRequest;
import com.domain.projectname.client.request.PutRequest;
import com.domain.projectname.client.request.DeleteRequest;
import com.domain.projectname.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/0.1.0/android");
